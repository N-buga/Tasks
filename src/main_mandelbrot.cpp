...
//    float sizeX = 2.0f;
    ...
    context.activate();
    {
        ...
        unsigned int global_work_sizeX = (width + workGroupSizeX - 1) / workGroupSizeX * workGroupSizeX;
        unsigned int global_work_sizeY = (height + workGroupSizeY - 1) / workGroupSizeY * workGroupSizeY;
